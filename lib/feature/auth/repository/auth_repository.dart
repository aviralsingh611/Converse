...
import 'package:converse/feature/auth/pages/verification_page.dart';
import 'package:converse/feature/home/pages/home_page.dart';
    ...
    try {
      ...
      await auth.verifyPhoneNumber(
        ...
        codeSent: (smsCodeId, resendSmsCodeId) {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context)=>VerificationPage(smsCodeId: smsCodeId, phoneNumber: phoneNumber)),
          );
